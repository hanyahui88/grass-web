 ...
 */
package com.grass.common.security.shiro.session;

import com.google.common.collect.Sets;
import com.grass.common.utils.ConfigUtils;
import com.grass.common.utils.DateUtils;
import com.grass.common.utils.JedisUtils;
import com.grass.common.utils.StringUtils;
import com.grass.common.web.Servlets;
...
public class JedisSessionDAO extends AbstractSessionDAO implements SessionDAO {
    ...
    public void update(Session session) throws UnknownSessionException {
        ...
        if (request != null) {
            ...
            // 如果是视图文件，则不更新SESSION
            if (StringUtils.startsWith(uri, ConfigUtils.getConfig("prefix"))
                    && StringUtils.endsWith(uri, ConfigUtils.getConfig("suffix"))) {
                return;
            }
            // 手动控制不更新SESSION
            if (ConfigUtils.getUpdateSession().equals(request.getParameter("updateSession"))) {
                return;
            }
        }

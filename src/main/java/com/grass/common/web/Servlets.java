 ...
 */
package com.grass.common.web;

import com.google.common.net.HttpHeaders;
import com.grass.common.utils.ConfigUtils;
import com.grass.common.utils.Encodes;
...
public class Servlets {
    ...
    // 静态文件后缀
    private final static String[] staticFiles = StringUtils.split(ConfigUtils.getConfig("web.staticFile"), ",");

    // 动态映射URL后缀
    private final static String urlSuffix = ConfigUtils.getUrlSuffix();

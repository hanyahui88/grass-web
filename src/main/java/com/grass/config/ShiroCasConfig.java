...
public class ShiroCasConfig {
    ...
    @Bean
    public GrassCasRealm shiroCasRealm(EhCacheManager ehCacheManager) {
    ...
    public DefaultWebSecurityManager getDefaultWebSecurityManager(GrassCasRealm myShiroCasRealm) {

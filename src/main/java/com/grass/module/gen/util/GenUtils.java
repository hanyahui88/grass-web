 ...
 */
package com.grass.module.gen.util;

import com.google.common.collect.Lists;
import com.google.common.collect.Maps;
import com.grass.common.mapper.JaxbMapper;
...
//		}
    ...
    public static Map<String, Object> getDataModel(GenScheme genScheme) {
        ...
        model.put("functionAuthor", StringUtils.isNotBlank(genScheme.getFunctionAuthor()) ? genScheme.getFunctionAuthor() : "hanyahui");
        ...
        model.put("dbType", ConfigUtils.getConfig("jdbc.type"));
    ...
    public static String generateToFile(GenTemplate tpl, Map<String, Object> model, boolean isReplaceFile) {
        // 获取生成文件
        String fileName = ConfigUtils.getProjectPath() + File.separator
